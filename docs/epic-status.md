...
- **E02/E03/E04/E05/E15/E20:** governed grid utilities are now part of the Data Grid frame itself for Accounts, Leads and all epic workspaces. Group, Audit, Export Excel, Export Word, Export PDF and Full size/Restore stay in the sticky grid header in both normal and expanded views.
